...
class WandBLogger(Logger):
    ...
    def __init__(self, *args, run_name=None, project_name=None, entity=None, disabled=False, **kwargs):
        ...
        if kwargs.get('master', True):
            ...
            self.wandb_handle = wandb.init(name=run_name, project=project_name, entity=entity, force=True, mode=mode)
        super().__init__(*args, **kwargs)
